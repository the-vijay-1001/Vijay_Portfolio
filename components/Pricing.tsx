  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage:
            "url(https://cdn.dribbble.com/users/1177926/screenshots/18709159/media/99719daaec651257b46bf4b8c378f263.gif)",
        }}
      >
        ...
        <div className="flex flex-col justify-between items-center lg:flex-row lg:items-start">
          <div className="w-full flex-1 mt-8 p-8 order-2 bg-neutral-200 shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-1 lg:rounded-r-none">
            ...
            <a
              href="#/"
              className="flex justify-center items-center bg-indigo-600 rounded-xl py-2 px-4 text-center text-white text-xl"
            >
              Choose Plan
              <img
          ...
          <div className="w-full flex-1 p-8 order-1 shadow-xl rounded-3xl bg-gray-900 text-gray-400 sm:w-96 lg:w-full lg:order-2 lg:mt-0">
            ...
            <a
              href="#/"
              className="flex justify-center items-center bg-indigo-600 rounded-xl py-3 px-4 text-center text-white text-2xl"
            >
              Choose Plan
              <img
                src="https://res.cloudinary.com/williamsondesign/arrow-right.svg"
          ...
          <div className="w-full flex-1 mt-8 p-8 order-3 bg-neutral-200 shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-3 lg:rounded-l-none">
            <div className="mb-7 pb-7 flex items-center border-b border-gray-300">
              <img
